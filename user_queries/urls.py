...
from user_queries.views.inventory_views import InventoryEdit, InventoryNew, InventoryPending
...
from user_queries.views.restoration_views import RestorationNew
from user_queries.views.movements_views import MovementsManage
